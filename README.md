## object_recognition_core (kinetic) - 0.6.7-0

The packages in the `object_recognition_core` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic object_recognition_core` on `Thu, 02 Feb 2017 21:27:42 -0000`
